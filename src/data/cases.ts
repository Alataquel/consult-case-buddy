...
This case illustrates the principle that optimal pricing isn't always about maximizing volume—sometimes value extraction from a smaller, high-quality customer base creates better financial outcomes and stronger brand equity.`,
  ...
  },
  {
    ...
    questions: [
      ...
      {
        number: 2,
        question: "Quantitative — Which product creates more value per customer?\nUse the unit economics below to calculate the Net Customer Lifetime Value (CLTV) for both options.\n\nNote:\n• Hardware purchases are one-time\n• Subscriptions are monthly\n• Customer Lifespan = 1 ÷ Monthly Churn Rate\n• Assume discount rate is negligible for this calculation\n\nUnit Economics:\n\nOption A: 'Aura Pure' (App Only)\n- Upfront Hardware Revenue: €0\n- Upfront Hardware Cost: €0\n- Monthly Subscription Price: €6.00\n- Cost to Serve (Cloud/Support): €1.00 per month\n- Customer Acquisition Cost (CAC): €25\n- Monthly Churn Rate: 5.0%\n\nOption B: 'Aura Hub' (Hardware + App)\n- Upfront Hardware Revenue: €180\n- Upfront Hardware Cost: €140\n- Monthly Subscription Price: €10.00\n- Cost to Serve (Cloud/Support): €2.00 per month\n- Customer Acquisition Cost (CAC): €120\n- Monthly Churn Rate: 2.0%",
        hints: [
