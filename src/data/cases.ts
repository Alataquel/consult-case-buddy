...
This case illustrates the principle that optimal pricing isn't always about maximizing volume—sometimes value extraction from a smaller, high-quality customer base creates better financial outcomes and stronger brand equity.`,
  ...
  // PRICING STRATEGY - Intermediate (Phased Information Release)
  {
    id: "car-rental-mileage-pricing",
    title: "Luxury Car Rental — Mileage Pricing Strategy",
    firm: "Pricing Strategy",
    type: "Pricing Strategy",
    background: `Your client is an international luxury car rental company.

Current Pricing Model:
• Daily rental rate: €220 per day
• Advertised as "unlimited" mileage to customers

The Hidden Reality:
Internally, the company calculates all costs and margins based on an assumption that customers drive no more than 300 km per day.

The Problem:
Customers are increasingly driving more than 300 km per day, which erodes the company's profit margins. The company has decided to start charging for kilometers driven above the 300 km daily limit.`,
    question: "For which price should every additional kilometer above the 300 km limit be priced?",
    difficulty: "Intermediate",
    questions: [
      {
        number: 1,
        question: `PHASE 1: Strategic Inquiry

Before diving into calculations, what questions would you ask the interviewer to clarify the objective and constraints of this pricing problem?
...
• Scope of the analysis`,
        hints: [
          "What is the company's target profitability or margin expectation?",
          "Is there a specific margin we need to maintain for additional kilometers?",
          "Should we consider competitive pricing or focus solely on cost-based pricing?"
        ],
        answer: `INTERVIEWER RESPONSE TO YOUR QUESTIONS:

1. "What is the company's profitability expectation?"
→ The general profitability expectation for the company is 9%.

2. "What margin should be maintained for additional kilometers?"
→ The current margin of 9% must be maintained for pricing additional kilometers.

3. "What is the scope of this analysis?"
→ Focus strictly on pricing. Other aspects (marketing, operations, competitive response) can be ignored for now.

---

Key Takeaways:

• Target margin: 9% on selling price
• Method: Cost-based pricing is appropriate since we have clear cost data and margin targets
• Scope: Pure pricing exercise—no need to consider broader strategic factors`
      },
      {
        number: 2,
        question: `PHASE 2: Cost Structure Brainstorming

Before receiving the quantitative data, structure your thinking by categorizing the types of costs a luxury car rental company would incur.

Divide costs into:
• Fixed Costs (don't change with kilometers driven)
• Variable Costs (change with each additional kilometer)

This categorization is critical for determining which costs are relevant for pricing additional kilometers.`,
        hints: [
          "Fixed costs are incurred regardless of how much the car is driven",
          "Variable costs directly scale with usage (kilometers driven)",
          "Think about what physically degrades or gets consumed when driving more"
        ],
        answer: `EXPECTED COST CATEGORIZATION:

Fixed Costs (Per Rental/Vehicle):
• Personnel costs (permanent staff salaries)
• Rent for buildings, parking garages, and rental stations
• Leasing or purchase price of vehicles (acquisition cost)
• Insurance premiums
...
• Depreciation / Wear and tear (directly tied to usage)
• Fuel (if included in rental)
• Utilities related to vehicle operation

---

KEY INSIGHT:

For pricing additional kilometers beyond the 300 km limit, only VARIABLE COSTS are relevant.

Why? Fixed costs are already covered by the base €220/day rate which assumes 300 km of usage. Any kilometers beyond 300 only incur additional variable costs.`
      },
      {
        number: 3,
        question: `PHASE 3: Quantitative Analysis
...
Step 1: Calculate the variable cost per kilometer (depreciation-based)

Step 2: Verify the current profitability at the 300 km baseline

Step 3: Determine the price per additional kilometer that maintains the 9% margin

CRITICAL: Show your work for each step. Pay attention to whether you should multiply or divide to achieve a margin on the selling price.`,
        hints: [
          "Variable cost per km = (Purchase Price - Resale Value) ÷ Total km lifespan",
          "Current profit = Revenue - (Fixed costs + Variable costs for 300 km)",
          "For margin on PRICE (not cost): Price = Cost ÷ (1 - Margin%)",
          "WARNING: Calculating Cost × (1 + Margin%) gives markup on cost, NOT margin on price"
        ],
        answer: `STEP-BY-STEP SOLUTION:

═══════════════════════════════════════════════════════
STEP 1: Calculate Variable Cost per Kilometer
═══════════════════════════════════════════════════════

Depreciation = Purchase Price - Resale Value
Depreciation = €100,000 - €90,000 = €10,000

Variable Cost per km = Depreciation ÷ Total km
Variable Cost per km = €10,000 ÷ 20,000 km = €0.50/km

═══════════════════════════════════════════════════════
STEP 2: Verify Current Profitability (300 km Baseline)
═══════════════════════════════════════════════════════

Revenue: €220 (daily rate)
...
Margin Check: €20 ÷ €220 = 9.09% ≈ 9% ✓

Current pricing achieves the 9% target margin.

═══════════════════════════════════════════════════════
STEP 3: Price per Additional Kilometer
═══════════════════════════════════════════════════════
...
CORRECT FORMULA (Margin on Price):
...
This calculates MARKUP on cost (9% above cost), not margin on price.

✓ CORRECT: €0.50 ÷ 0.91 = €0.5495
This ensures the 9% margin is calculated on the selling PRICE.

The difference matters:
• Markup method: Profit = €0.045, Margin = 8.26% (fails target)
• Margin method: Profit = €0.0495, Margin = 9.00% (hits target)`
      }
    ],
...
• Goal: Price additional km to maintain 9% profit margin

COST STRUCTURE:
• Fixed costs: €50/rental (already covered by base rate)
• Variable costs: €0.50/km (€10,000 depreciation ÷ 20,000 km lifespan)
...
PRICING CALCULATION:
• Only variable costs (€0.50/km) apply to additional km
• Formula: Price = Cost ÷ (1 - Margin)
• Calculation: €0.50 ÷ 0.91 = €0.5495

RECOMMENDATION:
Charge 54.95 cents (≈€0.55) per kilometer for all km driven beyond the 300 km daily limit.

KEY INSIGHT:
Use division (Cost ÷ 0.91) not multiplication (Cost × 1.09) to achieve margin on selling price rather than markup on cost.`,
    keyFrameworks: [
      "Cost-Based Pricing",
