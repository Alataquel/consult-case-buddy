...
export const cases: Case[] = [
  ...
  },
  {
    ...
    title: "Solara Dynamics and ArcWind Technologies",
    firm: "McKinsey",
    type: "M&A",
    background: "**Client Background**\n\nSolara Dynamics is a global leader in renewable energy infrastructure, headquartered in Osaka, Japan, with annual revenues of $10 billion. For the past two decades, Solara has built large-scale solar and wind farms across Asia and Oceania. Its strength lies in engineering excellence, cost-efficient deployment, and operational optimization of mature technologies.\n\nHowever, as renewable penetration increases, the company faces declining margins and grid-balancing challenges. To sustain growth and remain competitive, Solara aims to expand into next-generation energy storage and turbine systems — areas requiring more advanced R&D capabilities than it currently possesses.\n\n**Situation Overview**\n\nTo accelerate this transition, Solara is considering acquiring ArcWind Technologies, a Norwegian start-up specializing in ultra-light composite turbine blades and AI-driven dynamic pitch control systems designed to increase wind farm efficiency by up to 25%.\n\nFounded 12 years ago by two former aerospace engineers, ArcWind employs 180 people and has developed a portfolio of prototype designs and patents. The company is publicly listed and currently valued at $1 billion.\n\nSolara has engaged a consulting team to assess whether acquiring ArcWind is strategically and financially justified.\n\n**Strategic Question**\n\nShould Solara Dynamics acquire ArcWind Technologies?",
    question: "Multi-part case with 3 questions",
    questions: [
      {
        number: 1,
        question: "What factors should Solara consider when deciding whether to acquire ArcWind Technologies?",
        hints: [
          "Start with an overall structure before diving into details."
        ],
        answer: "A strong answer might include:\n\n**Strategic Fit**\n• Alignment of ArcWind's technology focus (advanced blade materials, AI control) with Solara's growth strategy in next-gen renewables\n• Degree to which ArcWind helps Solara shift from project developer to technology innovator\n• Potential to enter offshore and floating wind segments using ArcWind's lightweight designs\n\n**R&D Capabilities**\n• Quality of ArcWind's engineering team and proprietary algorithms\n• Depth of research partnerships with universities or aerospace suppliers\n• Strength and defensibility of patents\n\n**Financial and Market Considerations**\n• Acquisition price ($1 billion valuation)\n• Forecasted demand for higher-efficiency turbines and retrofit upgrades\n• Cost to scale production from prototypes to full commercial deployment\n\n**Alternatives**\n• Building equivalent capabilities in-house\n• Forming joint ventures or licensing ArcWind's technology instead of full acquisition\n\nA top-tier answer could also highlight regulatory, supply-chain, and geopolitical aspects — e.g., EU subsidies for green technology, rare material sourcing risks, and competition from Chinese turbine innovators."
      },
      {
        number: 2,
        question: "What issues should the team consider when evaluating the value of ArcWind's technology portfolio?",
        hints: [
          "Mention a broad set of factors before narrowing your focus."
        ],
        answer: "**Technical Feasibility**\n• How far along are ArcWind's innovations — conceptual models, field-tested prototypes, pilot-scale manufacturing, or certified components?\n• Probability of each stage progressing successfully to the next\n\n**Economic Potential**\n• Expected cost savings or efficiency gains per megawatt of turbine capacity\n• Market demand among wind farm developers for these improvements\n\n**Competitive Landscape**\n• Rival technologies from other turbine makers\n• Likelihood of technological obsolescence (e.g., rapid adoption of vertical-axis designs or superconducting generators)\n\n**Commercialization Costs**\n• Capital expenditure required to scale from pilot to mass production\n• Certification and safety testing costs for new materials\n\n**Intellectual Property**\n• Patent protection and the potential for reverse engineering\n• Exclusivity of AI control algorithms and access to sensor data for training\n\nA more sophisticated answer might also include:\n• Expected lifetime of technology relevance (how soon new designs may supersede it)\n• Dependencies on critical materials (e.g., carbon composites, rare earth magnets)"
      },
      {
        number: 3,
        question: "Solara believes that the success probability of ArcWind's flagship turbine system could be improved by funding an expanded aerodynamic field testing program. The additional investment would be $150 million.\n\n**Current Development Pipeline:**\n• Stage I (Design validation): 70%\n• Stage II (Field testing): 40%\n• Stage III (Certification): 50%\n• Stage IV (Commercial deployment): 90%\n\nIf the turbine system reaches successful commercial deployment, its expected NPV is $1.2 billion.\n\nBy how much must the Stage II (field testing) success rate increase for the $150 million investment to break even?",
        hints: [
          "Explain each step clearly."
        ],
        answer: "**Current expected value after Stage II:**\n• From Stage III onward: 50% × 90% = 45%\n• Value conditional on passing Stage II = 0.45 × $1.2B = $540M\n\n**To justify the $150M investment:**\n• The expected value after Stage II must rise to $540M + $150M = $690M\n• Therefore, overall probability after Stage II must increase by: $150M / $540M = 28 percentage points\n\n**Current cumulative probability to Stage II:**\n• 70% × 40% = 28%\n\n**Required cumulative probability for break-even:**\n• 28% + 28% = 56%\n\n**To reach 56%, Stage II probability must be:**\n• 56% / 70% = 80%\n\n✅ **Answer:** The Stage II success rate must increase from 40% to 80% — a 40-percentage-point jump — for the $150M investment to break even.\n\n**Interpretation:** This would be an extremely ambitious target — effectively doubling the field-testing success rate. Solara would need to assess whether such an improvement is plausible given technical constraints, weather variability, and prototype costs."
      }
    ],
    difficulty: "Advanced",
    modelSolution: "This is a multi-part case study covering M&A strategy for renewable energy technology, technology portfolio assessment, and probability-weighted investment analysis. See individual question answers for detailed solutions.",
    keyFrameworks: ["M&A Evaluation Framework", "Technology Valuation", "Renewable Energy Assessment", "Risk-Return Analysis"]
  },
  {
